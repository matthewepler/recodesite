...
def get_api(connection, **kwargs):
    return twitter.Api(consumer_key=kwargs.get(os.environ.get('consumer_key')),
                       consumer_secret=kwargs.get(os.environ.get('consumer_secret')),
...
def get_connection_values(response=None, **kwargs):
    ...
    api = twitter.Api(consumer_key=kwargs.get(os.environ.get('consumer_key')),
                      consumer_secret=kwargs.get(os.environ.get('consumer_secret')),
